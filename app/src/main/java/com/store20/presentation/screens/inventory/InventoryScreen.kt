...
// import androidx.compose.foundation.layout.Row // Not used directly
...
import com.store20.presentation.screens.inventory.InventoryViewModel // Updated import for ViewModel
...
fun InventoryScreen(
    ...
    viewModel: InventoryViewModel = hiltViewModel() // Assuming InventoryViewModel will be moved
) {
    ...
    LaunchedEffect(key1 = Unit) { // Use Unit to launch once, or viewModel if it can change
        viewModel.errorEvents.collectLatest { errorMessage ->
            // Assuming errorMessage is a direct string for now, or a resource ID if ViewModel is updated
...
@Composable
fun ProductListItem(
    product: Product, // Updated to use com.store20.domain.models.Product
